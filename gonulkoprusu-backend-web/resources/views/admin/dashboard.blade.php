...
<div class="stat-grid">
        ...
        <div class="stat-card stat-card--online">
            <div class="stat-card-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12.5l4 4L19 6"/><circle cx="12" cy="12" r="10"/></svg>
            </div>
            <div class="stat-card-body">
        ...
        <div class="stat-card stat-card--offline">
            ...
            <div class="stat-card-body">
                <div class="stat-value" id="statOfflineUsers">{{ $stats['offline_users'] }}</div>
                <div class="stat-label">Çevrimdışı Kullanıcı</div>
            </div>
        </div>
...
<script src="{{ rtrim(config('app.asset_url') ?: config('app.url'), '/') }}/js/admin-dashboard.js?v=online-status-1"></script>
@endsection
